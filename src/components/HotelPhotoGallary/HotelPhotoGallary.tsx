            ...
            <div className="hidden md:grid grid-cols-2 h-full gap-5">
                {
                    displayPhotos.map((photo, index) => (
                        <div key={index} className="cursor-pointer  rounded-2xl overflow-hidden h-64 ">
                            <Image alt={`Room Photo ${index + 2}`}
                                src={photo.url} width={150} height={150}
                ...
                }
                {
                    remainingPhotosCount > 0 && (
                        <div className="cursor-pointer relative h-64 rounded-2xl overflow-hidden "
