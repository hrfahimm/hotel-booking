const NewsLetter = () => {
    return (
      <section className='container mx-auto px-4'>
        <form className='bg-gray-600 text-white px-4 rounded-xl md:rounded-[30px] flex flex-col justify-center items-center py-6 md:py-24'>
          ...
          <div className='flex-col justify-center w-full md:flex-row flex pt-12'>
            <input
              ...
              className='bg-gray-300 h-11 md:h-16 mb-2 md:mb-0 rounded-xl pl-6 md:mr-5 md:w-[452px] text-black placeholder:text-black focus:outline-none'
            />
